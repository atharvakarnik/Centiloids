...
sbatch \
    --export=PROJ_DIR="${PROJ_DIR}",DATA_DIR="${DATA_DIR}",LIST_DIR="${LIST_DIR}",PROTO_DIR="${PROTO_DIR}",SUBJECT_LIST="${SUBJECT_LIST}",PET_TAG="${PET_TAG}",FSLOUTPUTTYPE='NIFTI_GZ',HOME="${HOME}",FSLDIR="${FSLDIR}" \
